...
Rails 4.2 example application demonstrates how to sell a product using "Stripe Checkout":https://stripe.com/checkout. The application uses:
...
* "Signup and Download Tutorial":https://tutorials.railsapps.org/rails-signup-download

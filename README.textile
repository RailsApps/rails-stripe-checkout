...
Rails 4.2 example application demonstrates how to sell a product using "Stripe Checkout":https://stripe.com/checkout. Use this example application as a starter app for your own web applications.
